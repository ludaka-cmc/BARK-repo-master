...
return [
    ...
    */
    ...
    'developer_name' => 'The American Kennel Club, Inc',

    // Developer website. Link in footer.
    'developer_link' => 'https://akc.org',
    ...
    */
    ...
    'user_model_fqn' => AKCBark\Models\Admin\BackpackUser::class,

    // The classes for the middleware to check if the visitor is an admin
    // Can be a single class or an array of clases
    'middleware_class' => [
        AKCBark\Http\Middleware\CheckIfAdmin::class,
